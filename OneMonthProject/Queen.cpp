...
Queen::Queen(int _playerNumber, POINT birthXY)
{
	progressBar = new ProgressBar;
	unitStatus.unitKind = QUEEN;

	unitStatus.playerNumber = _playerNumber;

	unitStatus.unitMaxHp = 120;
	...
	unitStatus.unitPortraitsImage = IMAGEMANAGER->FindImage("portraitsQueen");
...
void Queen::RenderShadow(HDC hdc)
{
